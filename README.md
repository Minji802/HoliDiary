...
# HoliDiary <br><br> ###여행 정보를 기록하여 공유하는 커뮤니티 웹 사이트 [KR]
...
## Description
<img width="600" src="https://user-images.githubusercontent.com/107027223/192584986-f5ab6106-cfe4-4e6a-aae4-fb48a10f08d4.png"/> <br>
...
# HoliDiary : 旅行情報を記録するコミュニティウェブサイト [JP]
**2022 Final-Project Team ３** <br>
...
旅行は実際の趣味活動に多くの比重を占めています。多くの人が旅行に対する憧れの心を持っており、最近はオンライン活動が活発になっています。旅行を趣味として持っている人たちが活発にコミュニケーションできるウェブサイトを作ろうとしました。休暇を意味するHolidayと日記を意味するDiaryを合わせて旅行を記録するコミュニティサイト、「HoliDiary」の制作を決定しました。<br>
...
|[ダイアリー掲示板]<br>掲示板UI構成<br>GoogleマップAPI<br>ポスト登録/コメント/いいね/共有<br>リーダー・GitMaster|[ダイアリーメイン画面]<br>ダイアリーメイン画面(天気情報API)<br>ダイアリー修正<br>スケジューラー<br>ダイアリーCSS|[ユーザ管理]<br>ログイン(ソーシャルログインAPI)<br>マイページ・登録<br>ダイアリー訪問者統計<br>ログイン・マイページCSS|[メイン画面]<br>メインホームCSS<br>最新・人気順掲示板<br>販売メニュー(機能X)<br>国別旅行レビュー集め|
|[다이어리 게시판]<br>게시판 UI 구성<br>구글 맵 API<br>글쓰기/댓글/좋아요/공유<br>리더 겸 Git Master|[다이어리 메인화면]<br>다이어리 메인화면(날씨 API)<br>다이어리 자체수정<br>스케쥴러<br>다이어리CSS|[유저 관리]<br>로그인(소셜로그인API)<br>마이페이지 및 구독<br>다이어리 방문자 현황<br>로그인・마이페이지CSS|[메인화면]<br>전체 틀 CSS<br>최신글, 인기글<br>판매(기능구현x)<br>국가별 여행후기 모아보기|
