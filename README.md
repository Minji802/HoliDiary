...
|**リーダー・GitMaster**<br>[ダイアリー掲示板]<br>掲示板UI構成<br>GoogleマップAPI<br>ポスト登録/コメント/いいね/共有|[ダイアリーメイン画面]<br>ダイアリーメイン画面(天気情報API)<br>ダイアリー修正<br>スケジューラー<br>ダイアリーCSS|[ユーザ管理]<br>ログイン(ソーシャルログインAPI)<br>マイページ・登録<br>ダイアリー訪問者統計<br>ログイン・マイページCSS|[メイン画面]<br>メインホームCSS<br>最新・人気順掲示板<br>販売メニュー(機能X)<br>国別旅行レビュー集め|
